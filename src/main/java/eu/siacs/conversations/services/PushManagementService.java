...
public class PushManagementService {
    ...
    void registerPushTokenOnServer(final Account account) {
        ...
        retrieveFcmInstanceToken(token -> {
            ...
            final IqPacket packet = mXmppConnectionService.getIqGenerator().pushTokenToAppServer(account,getAppServer(), token, androidId);

            Log.d(Config.LOGTAG, ": FCM TOKEN FOUND: "+token);
            Log.d(Config.LOGTAG, ": FCM STANZA : "+packet);
