...
public class RtpSessionStatus {
    ...
    public static @DrawableRes int getDrawable(final boolean received, final boolean successful) {
        if (received) {
            if (successful) {
                return R.drawable.ic_call_received_black_18dp;
            } else {
                return R.drawable.ic_call_missed_black_18dp;
            }
        } else {
            if (successful) {
                return R.drawable.ic_call_made_black_18dp;
            } else {
                return R.drawable.ic_call_missed_outgoing_black_18dp;
            }
        }
    }
}
