...
public abstract class EthereumNetworkBase implements EthereumNetworkRepositoryType {
    ...
    public static final String TAG = "NetworkBase_TAG";
    ...
    public static int getBatchProcessingLimit(long chainId) {
        if (batchProcessingLimitMap.size() == 0)
            setBatchProcessingLimits(); //If batch limits not set, init them and proceed
    ...
    private final Set<eu.siacs.conversations.Repository.OnNetworkChangeListener> onNetworkChangedListeners = new HashSet<>();
...
//            }
    ...
    public void setActiveBrowserNetwork(NetworkInfo networkInfo) {
        if (networkInfo != null) {
            ...
            for (eu.siacs.conversations.Repository.OnNetworkChangeListener listener : onNetworkChangedListeners) {
    ...
    @Override
    public void addOnChangeDefaultNetwork(eu.siacs.conversations.Repository.OnNetworkChangeListener onNetworkChanged) {
