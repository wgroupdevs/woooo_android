...
public class RealmManager {
    ...
    public String getRealmInstanceName(Wallet wallet) {
        return wallet.address.toLowerCase() + "-woo-db.realm";
    }
    ...
    public Realm getRealmInstance(String walletAddress) {
        return getRealmInstanceInternal(walletAddress.toLowerCase() + "-woo-db.realm");
    }
    ...
    public Realm getWalletDataRealmInstance() {
        return getRealmInstanceInternal("WooWalletData-db.realm");
    }

    public Realm getWalletTypeRealmInstance() {
        return getRealmInstanceInternal("WooWalletType-db.realm");
    }
}
