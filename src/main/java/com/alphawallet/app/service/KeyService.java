...
//        requireAuthentication = false;
    ...
    public Credentials getCredentials(String address) {
        Credentials credentials = null;
        try {
            String password = "";
            File keyFolder = new File(context.getFilesDir(), KEYSTORE_FOLDER);
             credentials = KeystoreAccountService.getCredentials(keyFolder, address, password);

            Log.d(TAG,"Credentials : "+credentials.getEcKeyPair().getPrivateKey());
