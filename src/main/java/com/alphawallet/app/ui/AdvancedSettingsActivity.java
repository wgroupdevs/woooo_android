...
//            .withSubtitle(R.string.experimental_1559_tx_sub)
    ...
    private void askWritePermission()
    {
        ...
        ActivityCompat.requestPermissions(this, permissions, WalletHomeActivity.RC_ASSET_EXTERNAL_WRITE_PERM);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)
    {
        ...
        switch (requestCode)
        {
            case WalletHomeActivity.RC_ASSET_EXTERNAL_WRITE_PERM:
