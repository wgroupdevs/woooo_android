...
//            UpdateUtils.pushUpdateDialog(getActivity());
            ...
            if (getActivity() != null)
            {
                ((WalletHomeActivity) getActivity()).removeSettingsBadgeKey(C.KEY_UPDATE_AVAILABLE);
            }
        });
    }
...
//        appVersionText.setText(String.format(Locale.getDefault(), "%s (%d)", BuildConfig.VERSION_NAME, BuildConfig.VERSION_CODE));
    ...
    private void backupWarning(String s)
    {
        ...
        else
        {
            ...
            if (getActivity() != null)
                ((WalletHomeActivity) getActivity()).removeSettingsBadgeKey(C.KEY_NEEDS_BACKUP);
    ...
    void addBackupNotice(GenericWalletInteract.BackupLevel walletValue)
    {
        ...
        if (wallet != null)
        {
            ...
            if (getActivity() != null)
            {
                ((WalletHomeActivity) getActivity()).addSettingsBadgeKey(C.KEY_NEEDS_BACKUP);
            }
        }
    }
    ...
    private void backedUp(String walletAddress)
    {
        layoutBackup.setVisibility(View.GONE);
        if (getActivity() != null)
            ((WalletHomeActivity) getActivity()).postponeWalletBackupWarning(walletAddress);
    }
...
//                current.setText(getString(R.string.installed_version, BuildConfig.VERSION_NAME));
            ...
            if (getActivity() != null)
            {
                ((WalletHomeActivity) getActivity()).addSettingsBadgeKey(C.KEY_UPDATE_AVAILABLE);
            }
        }
        else
        {
