...
public class ApiV1
{
    public static final Method CONNECT = new Method(Path.CONNECT, CallType.CONNECT);
    public static final Method SIGN_PERSONAL_MESSAGE = new Method(Path.SIGN_PERSONAL_MESSAGE, CallType.SIGN_PERSONAL_MESSAGE);
