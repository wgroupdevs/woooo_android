...
@HiltViewModel
public class WalletHomeViewModel extends BaseViewModel
{
    public static final String WOOOOWALLET_DIR = "WooWallet";
    ...
    public void handleQRCode(WalletHomeActivity activity, String qrCode)
    {
        try
        {
...
//        RateApp.showRateTheApp(context, preferenceRepository, false);
    ...
    public void importScriptFile(WalletHomeActivity ctx, Intent startIntent)
    {
    ...
    private void handleImportAttestation(WalletHomeActivity activity, QRResult qrResult)
    {
    ...
    private void completeImport(WalletHomeActivity activity, Wallet wallet, QRResult qrResult)
    {
    ...
    public boolean handleSmartPass(WalletHomeActivity walletHomeActivity, String smartPassCandidate)
    {
        if (smartPassCandidate.startsWith(ImportAttestation.SMART_PASS_URL))
        {
            ...
            {
                handleImportAttestation(walletHomeActivity, result);
                return true;
            }
        }
