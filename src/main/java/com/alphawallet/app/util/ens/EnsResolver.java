...
{
    private final String TAG="EnsResolver_TAG";
    ...
    public EthCall resolve(byte[] name, byte[] data, String address) throws Exception
    {
        final Function function = new Function(FUNC_RESOLVE,
                Arrays.<Type>asList(new DynamicBytes(name),
    ...
    {
        final Function function = new Function(FUNC_RESOLVEWITHPROOF,
                Arrays.<Type>asList(new DynamicBytes(response),
