    ...
    public static void decorateTabLayout(Context context, TabLayout tabLayout) {
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                setSelectedTabFont(tabLayout, tab, ResourcesCompat.getFont(context, R.font.nasalization));
            }
        ...
        if (firstTab != null) {
            TabUtils.setSelectedTabFont(tabLayout, firstTab, ResourcesCompat.getFont(context, R.font.nasalization));
        }
    }
