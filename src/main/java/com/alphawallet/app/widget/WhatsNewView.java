...
public class WhatsNewView extends ConstraintLayout
{
    ...
    public WhatsNewView(Context context, List<GitHubRelease> items, OnClickListener onCloseListener)
    {
        super(context);
    ...
    public WhatsNewView(Context context, List<GitHubRelease> items, OnClickListener onCloseListener, boolean limitToLatest)
    {
