    ...
    public void onSigData(final XMLDsigDescriptor sigData, final Activity act)
    {
        ...
        switch (type)
        {
            ...
            case DEBUG_NO_SIGNATURE:
                lockResource = R.drawable.ic_unlocked_debug;
                break;
            case DEBUG_SIGNATURE_INVALID:
                lockResource = R.drawable.ic_unlocked_debug;
                break;
            case DEBUG_SIGNATURE_PASS:
                lockResource = R.drawable.ic_locked_debug;
                break;
            case NO_SIGNATURE:
                lockResource = R.drawable.ic_unverified;
                break;
            case SIGNATURE_INVALID:
                lockResource = R.drawable.ic_unverified;
                break;
            case SIGNATURE_PASS:
                lockResource = R.drawable.ic_locked;
                break;
        }
