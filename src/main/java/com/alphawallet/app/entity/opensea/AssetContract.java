...
public class AssetContract implements Parcelable {
    ...
    public String getCreationDate()
    {
        try
        {
            ...
            DateFormat timeFormat = DateFormat.getTimeInstance(DateFormat.SHORT, LocaleUtils.getDeviceLocale(getApplicationContext()));
            DateFormat dateFormat = DateFormat.getDateInstance(DateFormat.MEDIUM, LocaleUtils.getDeviceLocale(getApplicationContext()));
